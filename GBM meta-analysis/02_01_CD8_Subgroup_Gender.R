...
dir.create(paste0(output_dir_root,"//02_Subgroup//01_Gender"))
...
output_dir<-paste0(output_dir_root,"//02_Subgroup//01_Gender//Male")
dir.create(output_dir)
input_dataset<- readRDS(file = input_dataset.rds_path)
input_dataset<-subset(input_dataset,Gender=="Male")

####01_02 PMID15452186 start####
output_dir<-paste0(output_dir_root,"//02_Subgroup//01_Gender//Male//PMID15452186")
dir.create(output_dir)
#data preprocess
...
output_dir<-paste0(output_dir_root,"//02_Subgroup//01_Gender//Male//PMID18957964")
dir.create(output_dir)
#data preprocess
...
output_dir<-paste0(output_dir_root,"//02_Subgroup//01_Gender//Male//PMID29910795")
dir.create(output_dir)
#data preprocess
...
output_dir<-paste0(output_dir_root,"//02_Subgroup//01_Gender//Male//PMID33130898")
dir.create(output_dir)
#data preprocess
...
output_dir<-paste0(output_dir_root,"//02_Subgroup//01_Gender//Male//PMID33838625")
dir.create(output_dir)
#data preprocess
...
output_dir<-paste0(output_dir_root,"//02_Subgroup//01_Gender//Male//PMID37148198")
dir.create(output_dir)
#data preprocess
...
output_dir<-paste0(output_dir_root,"//02_Subgroup//01_Gender//Female")
dir.create(output_dir)
input_dataset<- readRDS(file = input_dataset.rds_path)
input_dataset<-subset(input_dataset,Gender=="Female")
####01_02 PMID15452186 start####
output_dir<-paste0(output_dir_root,"//02_Subgroup//01_Gender//Female//PMID15452186")
dir.create(output_dir)
#data preprocess
temp_dataset_id<-"PMID15452186"
temp_dataset<-input_dataset[input_dataset$PMID==temp_dataset_id,]
...
####01_02 PMID15452186 end####
####01_03 PMID18957964 start####
output_dir<-paste0(output_dir_root,"//02_Subgroup//01_Gender//Female//PMID18957964")
dir.create(output_dir)
#data preprocess
temp_dataset_id<-"PMID18957964"
temp_dataset<-input_dataset[input_dataset$PMID==temp_dataset_id,]
...
####01_03 PMID18957964 end####
####01_04 PMID29910795 start####
output_dir<-paste0(output_dir_root,"//02_Subgroup//01_Gender//Female//PMID29910795")
dir.create(output_dir)
#data preprocess
temp_dataset_id<-"PMID29910795"
temp_dataset<-input_dataset[input_dataset$PMID==temp_dataset_id,]
...
####01_04 PMID29910795 end####
####01_06 PMID33130898 start####
output_dir<-paste0(output_dir_root,"//02_Subgroup//01_Gender//Female//PMID33130898")
dir.create(output_dir)
#data preprocess
temp_dataset_id<-"PMID33130898"
temp_dataset<-input_dataset[input_dataset$PMID==temp_dataset_id,]
...
####01_06 PMID33130898 end####
####01_07 PMID33838625 start####
output_dir<-paste0(output_dir_root,"//02_Subgroup//01_Gender//Female//PMID33838625")
dir.create(output_dir)
#data preprocess
temp_dataset_id<-"PMID33838625"
temp_dataset<-input_dataset[input_dataset$PMID==temp_dataset_id,]
...
####01_07 PMID33838625 end####
####01_10 PMID37148198 start####
output_dir<-paste0(output_dir_root,"//02_Subgroup//01_Gender//Female//PMID37148198")
dir.create(output_dir)
#data preprocess
temp_dataset_id<-"PMID37148198"
temp_dataset<-input_dataset[input_dataset$PMID==temp_dataset_id,]
