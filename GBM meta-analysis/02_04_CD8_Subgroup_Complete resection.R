...
dir.create(paste0(output_dir_root,"//02_Subgroup//04_Complete resection"))
...
output_dir<-paste0(output_dir_root,"//02_Subgroup//04_Complete resection//Total excision")
dir.create(output_dir)
input_dataset<- readRDS(file = input_dataset.rds_path)
input_dataset<-input_dataset[(input_dataset$Complete_resection %in% c("Total excision", "Yes")),]

####01_02 PMID15452186 start####
output_dir<-paste0(output_dir_root,"//02_Subgroup//04_Complete resection//Total excision//PMID15452186")
dir.create(output_dir)
#data preprocess
...
output_dir<-paste0(output_dir_root,"//02_Subgroup//04_Complete resection//Total excision//PMID29910795")
dir.create(output_dir)
#data preprocess
...
output_dir<-paste0(output_dir_root,"//02_Subgroup//04_Complete resection//Total excision//PMID33130898")
dir.create(output_dir)
#data preprocess
...
output_dir<-paste0(output_dir_root,"//02_Subgroup//04_Complete resection//Subtotal excision")
dir.create(output_dir)
input_dataset<- readRDS(file = input_dataset.rds_path)
input_dataset<-subset(input_dataset,Complete_resection=="Subtotal excision")
####01_04 PMID29910795 start####
output_dir<-paste0(output_dir_root,"//02_Subgroup//04_Complete resection//Subtotal excision//PMID29910795")
dir.create(output_dir)
#data preprocess
temp_dataset_id<-"PMID29910795"
temp_dataset<-input_dataset[input_dataset$PMID==temp_dataset_id,]
...
####01_04 PMID29910795 end####
####01_06 PMID33130898 start####
output_dir<-paste0(output_dir_root,"//02_Subgroup//04_Complete resection//Subtotal excision//PMID33130898")
dir.create(output_dir)
#data preprocess
temp_dataset_id<-"PMID33130898"
temp_dataset<-input_dataset[input_dataset$PMID==temp_dataset_id,]
...
output_dir<-paste0(output_dir_root,"//02_Subgroup//04_Complete resection//Partial excision")
dir.create(output_dir)
input_dataset<- readRDS(file = input_dataset.rds_path)
input_dataset<-subset(input_dataset,Complete_resection=="Partial excision")
####01_04 PMID29910795 start####
output_dir<-paste0(output_dir_root,"//02_Subgroup//04_Complete resection//Partial excision//PMID29910795")
dir.create(output_dir)
#data preprocess
temp_dataset_id<-"PMID29910795"
temp_dataset<-input_dataset[input_dataset$PMID==temp_dataset_id,]
...
####01_04 PMID29910795 end####
####01_06 PMID33130898 start####
output_dir<-paste0(output_dir_root,"//02_Subgroup//04_Complete resection//Partial excision//PMID33130898")
dir.create(output_dir)
#data preprocess
temp_dataset_id<-"PMID33130898"
temp_dataset<-input_dataset[input_dataset$PMID==temp_dataset_id,]
