...
dir.create(paste0(output_dir_root,"//02_Subgroup//03_MGMT status"))
...
output_dir<-paste0(output_dir_root,"//02_Subgroup//03_MGMT status//methylated")
dir.create(output_dir)
input_dataset<- readRDS(file = input_dataset.rds_path)
input_dataset<-subset(input_dataset,MGMT_status=="methylated")

####01_04 PMID29910795 start####
output_dir<-paste0(output_dir_root,"//02_Subgroup//03_MGMT status//methylated//PMID29910795")
dir.create(output_dir)
#data preprocess
...
output_dir<-paste0(output_dir_root,"//02_Subgroup//03_MGMT status//methylated//PMID33130898")
dir.create(output_dir)
#data preprocess
...
output_dir<-paste0(output_dir_root,"//02_Subgroup//03_MGMT status//methylated//PMID37148198")
dir.create(output_dir)
#data preprocess
...
output_dir<-paste0(output_dir_root,"//02_Subgroup//03_MGMT status//unmethylated")
dir.create(output_dir)
input_dataset<- readRDS(file = input_dataset.rds_path)
input_dataset<-subset(input_dataset,MGMT_status=="unmethylated")
####01_04 PMID29910795 start####
output_dir<-paste0(output_dir_root,"//02_Subgroup//03_MGMT status//unmethylated//PMID29910795")
dir.create(output_dir)
#data preprocess
temp_dataset_id<-"PMID29910795"
temp_dataset<-input_dataset[input_dataset$PMID==temp_dataset_id,]
...
####01_04 PMID29910795 end####
####01_06 PMID33130898 start####
output_dir<-paste0(output_dir_root,"//02_Subgroup//03_MGMT status//unmethylated//PMID33130898")
dir.create(output_dir)
#data preprocess
temp_dataset_id<-"PMID33130898"
temp_dataset<-input_dataset[input_dataset$PMID==temp_dataset_id,]
...
output_dir<-paste0(output_dir_root,"//02_Subgroup//03_MGMT status//unmethylated//PMID33838625")
dir.create(output_dir)
#data preprocess
...
####01_10 PMID37148198 start####
output_dir<-paste0(output_dir_root,"//02_Subgroup//03_MGMT status//unmethylated//PMID37148198")
dir.create(output_dir)
#data preprocess
temp_dataset_id<-"PMID37148198"
temp_dataset<-input_dataset[input_dataset$PMID==temp_dataset_id,]
